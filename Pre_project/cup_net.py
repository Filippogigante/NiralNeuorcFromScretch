...
def scivolo(X, Y, hidden_layer_dim, eta, alpha, epochs):
    ...
    for i in range(epochs+1):
        ...
        Z1, A1, Z2 = fp(W1, b1, W2, b2, X_loc)
        dW1, db1, dW2, db2 = Backprop(Z1, Z2, A1, W2, Y_loc, X_loc)
...
epochs = 1500
r = scivolo(X_train, Y_train, hidden_layer_dim=64, eta=0.001, alpha=0.9, epochs=epochs)
